...
sections:
  ...
  - block: markdown
    ...
    content:
      ...
      subtitle: ''
      text: |-
        My current work focuses on advancing machine learning methods for spatial epidemiology. Traditional epidemiological models often struggle to capture nonlinear spatial dependencies and interactions among multiple risk factors. To address this, I have been exploring approaches that integrate spatial autocorrelation and machine learning to improve outbreak prediction, hotspot detection, and disease risk mapping. In parallel, I also employ Bayesian statistical methods to study spatiotemporal disease dynamics. Bayesian frameworks allow for the incorporation of prior knowledge and provide rigorous quantification of uncertainty, which is especially important when dealing with heterogeneous data across time and space. These research provide more accurate and fine-grained insights into disease dynamics, which can support early intervention strategies and better allocation of health resources.
